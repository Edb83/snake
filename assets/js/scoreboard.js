let scoreBoard = {
    ...
    print() {
        ...
        if (scoreRange(60, 69)) {
            scoreAwardText.insertAdjacentHTML("beforeend", `This is what cybernetic dreams are made of. `);
        }
        if (scoreRange(70, 79)) {
        ...
        if (scoreRange(100, 124) &&
            ...
            scoreAwardText.insertAdjacentHTML("beforeend", `In total you have smashed ${stats.pointsAllTime} blobs to smithereens. The Nanite Narwhal would be proud. `);
        }
